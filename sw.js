const CACHE='iap-mobile-v19-smart-performance-3';
const ASSETS=['./','./index.html','./styles.css','./app.js','./v19.css','./v19.js','./dispute-helper.js','./manifest.webmanifest','./icon48.png','./icon128.png'];
